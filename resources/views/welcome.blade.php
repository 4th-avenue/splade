            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">X-Splade-Data Component</div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            <x-splade-data :default="['name' => 'Laravel Splade']">
                                <input id="name" v-model="data.name" autofocus autocomplete="name" class="rounded-md" />
                                <p class="mt-2">Your name is <b><span v-text="data.name" /></b>.</p>
                            </x-splade-data>
                        </div>
                    </div>
                </div>
